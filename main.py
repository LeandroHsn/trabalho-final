...
# Criando as actions menuTransformações
        ...
        self.menuTransformacao.addSeparator()
        self.sub_Menu = self.menuTransformacao.addMenu("EFEITOS")
        self.menuTransformacao.addSeparator()
        self.efeito_find = self.sub_Menu.addAction("FIND_EDGES")
        self.efeito_find.triggered.connect(self.transform_me_findEdges)
        self.menuTransformacao.addSeparator()        
        self.efeito_contour = self.sub_Menu.addAction("CONTOUR")
        self.efeito_contour.triggered.connect(self.transform_me_countour)
        self.menuTransformacao.addSeparator()         
        self.efeito_emboss = self.sub_Menu.addAction("EMBOSS")
        self.efeito_emboss.triggered.connect(self.transform_me_emboss)
        self.menuTransformacao.addSeparator()
        self.efeito_blur = self.sub_Menu.addAction("BLUR")
        self.efeito_blur.triggered.connect(self.transform_me_blur)
        self.menuTransformacao.addSeparator()
        self.efeito_edge_enhance = self.sub_Menu.addAction("EDGE_ENHANCE")
        self.efeito_edge_enhance.triggered.connect(self.transform_me_edge_enhance)
        self.menuTransformacao.addSeparator()
        self.efeito_edge_enhance_more = self.sub_Menu.addAction("EDGE_ENHANCE_MORE")
        self.efeito_edge_enhance_more.triggered.connect(self.transform_me_edge_enhance_more)
        self.menuTransformacao.addSeparator()
        self.efeito_sharpen = self.sub_Menu.addAction("SHARPEN")
        self.efeito_sharpen.triggered.connect(self.transform_me_sharpen)
        self.menuTransformacao.addSeparator()
        self.efeito_smooth = self.sub_Menu.addAction("SMOOTH")
        self.efeito_smooth.triggered.connect(self.transform_me_smooth)
        self.menuTransformacao.addSeparator()
        self.efeito_smooth_more = self.sub_Menu.addAction("SMOOTH_MORE")
        self.efeito_smooth_more.triggered.connect(self.transform_me_smooth_more)
        self.menuTransformacao.addSeparator()
        self.efeito_detail = self.sub_Menu.addAction("DETAIL")
        self.efeito_detail.triggered.connect(self.transform_me_detail)
        self.menuTransformacao.addSeparator()
        self.sub_Menu4 = self.menuTransformacao.addMenu("DETECÇÃO DE BORDA")
        self.menuTransformacao.addSeparator()
        self.efeito_detectar1 = self.sub_Menu4.addAction("DETECTAR ESTILO BORDA 1")
        self.efeito_detectar1.triggered.connect(self.transform_me_deteccao_borda_1)
        self.menuTransformacao.addSeparator()
        self.efeito_detectar2 = self.sub_Menu4.addAction("DETECTAR ESTILO BORDA 2")
        self.efeito_detectar2.triggered.connect(self.transform_me_deteccao_borda_2)
        self.menuTransformacao.addSeparator()
        self.efeito_detectar3 = self.sub_Menu4.addAction("DETECTAR ESTILO BORDA 3")
        self.efeito_detectar3.triggered.connect(self.transform_me_deteccao_borda_3)
        self.menuTransformacao.addSeparator()
        self.sub_Menu2 = self.menuTransformacao.addMenu("CAMADA RGB")
        self.menuTransformacao.addSeparator()
        self.efeito_camada_R = self.sub_Menu2.addAction("CAMADA_R")
        self.efeito_camada_R.triggered.connect(self.transform_me_camada_R)
        self.menuTransformacao.addSeparator()
        self.efeito_camada_G = self.sub_Menu2.addAction("CAMADA_G")
        self.efeito_camada_G.triggered.connect(self.transform_me_camada_G)
        self.menuTransformacao.addSeparator()
        self.efeito_camada_B = self.sub_Menu2.addAction("CAMADA_B")
        self.efeito_camada_B.triggered.connect(self.transform_me_camada_B)
        self.menuTransformacao.addSeparator()
        self.sub_Menu3 = self.menuTransformacao.addMenu("FILTRO GAMMA")
        self.menuTransformacao.addSeparator()
        self.efeito_camada_gamma_0p3 = self.sub_Menu3.addAction("GAMMA_0.3")
        self.efeito_camada_gamma_0p3.triggered.connect(self.transform_me_gamma_0p3)
        self.menuTransformacao.addSeparator()
        self.efeito_camada_gamma_1p8 = self.sub_Menu3.addAction("GAMMA_1.8")
